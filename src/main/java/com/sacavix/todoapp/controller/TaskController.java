...
public class TaskController {
    ...
    @PostMapping
    public TaskInDTO createTask(@RequestBody TaskInDTO taskInDTO) {
    ...
    public ResponseEntity<TaskInDTO> updateTask(@RequestBody TaskInDTO taskInDTO,@PathVariable Long id){
        this.taskService.updateTaskInDto(taskInDTO, id);
